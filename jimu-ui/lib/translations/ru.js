define({
  ...
  addDataByUrlHint: 'Поддерживаются только сервисы объектов и картографические сервисы с HTTPS.',
  source: 'Источник',
  settings: 'Установки',
  home: 'На главную',
  widgets: 'Виджеты',
  ...
  whatsNewStep2Title: 'Виджет Карточка',
  whatsNewStep2Content: 'Включает текст, кнопки, изображения и другие виджеты в этом гибком и расширяемом контейнере.',
  whatsNewStep3Title: 'Представления данных',
  whatsNewStep3Content: 'Создает разные представления векторного слоя, с помощью добавления фильтров и критериев сортировки.',
  whatsNewStep4Title: 'Виджет Закладка',
  whatsNewStep4Content: 'Добавляет горячие клавиши для предварительно заданных местоположений, для организации и использования в интерактивных историях.',
  whatsNewStep5Title: 'Анимация',
  whatsNewStep5Content: 'Дает возможность создавать привлекательную анимацию в виджетах с помощью переходных движений, таких как влёт, вращение и проявление.',
  whatsNewStep6Title: 'Виджет Драйвер',
  whatsNewStep6Content: 'Добавляет визуальные линии для разделения виджетов на секции.',
  whatsNewStep7Title: 'Окна',
  whatsNewStep7Content: 'Открывает модальное окно, которое появляется при загрузке страницы или активации другого виджета. Опции включают Предупреждение, Подтверждение, Простой и Новый.',
  whatsNewStep8Title: 'Установки',
  whatsNewStep8Content: 'Добавляет несколько опций, например, копирование виджета с помощью кнопки дублирования, закрепления виджета, чтобы он был видимым или изменения ротации виджетов.',
  whatsNewStep9Title: 'Типы данных',
  whatsNewStep9Content: 'Предоставляет новые типы данных, включая слои картографических сервисов и составные слои.',
  whatsNewStep10Title: 'Виджет Фильтр',
  whatsNewStep10Content: 'Отображает виджет фильтра в виде кнопки с помощью нового входного стиля выбора знака, а также новых стилей расположения и активации для настройки дизайна пользовательского интерфейса.',
  whatsNewStep11Title: 'Виджет Изображение',
  whatsNewStep11Content: 'Добавляет поддержку для включения вложений векторных слоев и символов объектов веб-карт в виджет изображения.',
  whatsNewStep12Title: 'Виджет Просмотр навигации',
  whatsNewStep12Content: 'Обеспечивает различные опции видов навигации в пользовательском интерфейсе.',
  ...
  // guide insert widget
  insertWidgetStep1Title: 'Вставить {widgetName}',
  insertWidgetStep1Content: 'Щелкните виджет {widgetName} и перетащите его на канву',
  // animation
  animation: 'Анимация',
